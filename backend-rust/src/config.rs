...
pub struct Config {
    ...
    pub core100_retry_model: String,
    pub core100_fallback_model: String,
...
impl Config {
    pub fn load() -> Self {
        ...
        Self {
            ...
            core100_retry_model: env_or("CORE100_RETRY_MODEL", "glm-4.6v-flash"),
            core100_fallback_model: env_or("CORE100_FALLBACK_MODEL", "glm-4.6v"),
