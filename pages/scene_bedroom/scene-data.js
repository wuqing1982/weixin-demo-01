const sceneData = {
  ...
  items: [
    {id: 'bookshelf', word: 'bookshelf', ipa: '/bʊkˌʃelf/', meaning: '书架', sentence: 'Look at the bookshelf with many books.', sentenceTranslation: '看那个有很多书的书架。', rect: {l: 30.0, t: 40.0, w: 35.0, h: 50.0}, audio: '/assets/audio/bedroom/bedroom_en-US-JennyNeural_US_female_1_look_at_the_bookshelf_with_many.mp3'},
  ...
  verbs: [
    {id: '1', word: 'look at', ipa: '/lʊk æt/', meaning: '看', sentence: 'Look at the bookshelf with many books.', sentenceTranslation: '看看书架上有很多书。', audio: '/assets/audio/bedroom/bedroom_en-US-JennyNeural_US_female_1_look_at_the_bookshelf_with_many.mp3'},
    {id: '2', word: 'hang', ipa: '/hæŋ/', meaning: '挂', sentence: 'Hang the teddy bear on the wall.', sentenceTranslation: '把泰迪熊挂在墙上。', audio: '/assets/audio/bedroom/bedroom_en-US-JennyNeural_US_female_2_hang_the_teddy_bear_on_the.mp3'},
    {id: '3', word: 'sit', ipa: '/sɪt/', meaning: '坐', sentence: 'Sit on the beanbag to read a book.', sentenceTranslation: '坐在豆袋椅上读一本书。', audio: '/assets/audio/bedroom/bedroom_en-US-JennyNeural_US_female_3_sit_on_the_beanbag_to_read.mp3'}
  ],
};
